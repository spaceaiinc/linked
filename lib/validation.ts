...
export const searchProfileSchema = yup
  .object({
    ...
    run_limit_count: yup
      .number()
      .transform((value) =>
        value === '' || isNaN(Number(value)) ? 1000 : Number(value)
      )
      .nullable(),
    ...
    first_message_trigger_type: yup
      ...
      .default(0),
    second_message_dify_api_key: yup.string().nullable(),
    second_message_trigger_type: yup
      .number()
      .transform((value) =>
        value === '' || isNaN(Number(value)) ? 0 : Number(value)
      )
      .default(0),
    third_message_dify_api_key: yup.string().nullable(),
    third_message_trigger_type: yup
      .number()
      .transform((value) =>
        value === '' || isNaN(Number(value)) ? 0 : Number(value)
      )
