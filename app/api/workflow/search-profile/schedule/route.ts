  ...
  try {
    ...
    const workflowPromises = workflows.map(async (workflow: Workflow) => {
      ...
      const searchProfileParam: SearchProfileParam = {
        ...
        first_message_trigger_type: workflow.first_message_trigger_type,
        second_message_trigger_type: workflow.second_message_trigger_type,
        third_message_trigger_type: workflow.third_message_trigger_type,
